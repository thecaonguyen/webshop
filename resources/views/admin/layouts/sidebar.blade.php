      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{ route('admin.category.create') }}"><i class="fa fa-circle-o"></i> Thêm danh mục </a></li>
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{ route('admin.product.create') }}"><i class="fa fa-circle-o"></i> Thêm sản phẩm </a></li>
